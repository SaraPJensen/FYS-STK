...
Each component of the of the computed eigenvector was plotted as a function of epoch, to see how fast it converges. This is shown in Figure \ref{fig:eigvec_converge}. Most of the elements seem to have converged already after about 30 epochs, though then the relative error of the eigenvalue was bigger, with the log of it at $-3.25$. After 100 epochs, it was even better, at $-5.94$, though this seems to be close to a limit, as after 200 epochs, it was marginarlly better, at $-5.95$.
